...
require_once( plugin_dir_path(__FILE__ ) . '/remove_some_fields_on_checkout/remove_some_fields_on_checkout.php' );
 
// валидация телефона при оформлении заказа
require_once( plugin_dir_path(__FILE__ ) . '/validate_billing_phone_number/validate_billing_phone_number.php' );